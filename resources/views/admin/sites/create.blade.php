                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="crm_api_url" name="crm[api_url]" 
                               value="{{ old('crm.api_url') }}" placeholder="https://crm.example.com/api/leads">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="crm_api_key" name="crm[api_key]" 
                               value="{{ old('crm.api_key') }}" placeholder="your_crm_api_key">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="crm_entry_point" name="crm[entry_point]" 
                               value="{{ old('crm.entry_point', 'website_form') }}" placeholder="website_form">
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="crm_enabled" name="crm[enabled]" 
                                   value="1" {{ old('crm.enabled') ? 'checked' : '' }}>
